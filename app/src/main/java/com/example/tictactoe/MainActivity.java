...
public class MainActivity extends AppCompatActivity {
    ...
    private void initElements() {
        ...
        btn10 = findViewById(R.id.btnRestart);
    }
    ...
    private void initAction() {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MainActivity.this, "Let's Play game", Toast.LENGTH_SHORT).show();
            }
        }, 500);
    }
    ...
    public void restart() {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(MainActivity.this, "Start New Game", Toast.LENGTH_SHORT).show();
                btn1.setText("");
                btn2.setText("");
                btn3.setText("");
                btn4.setText("");
